...
legend("topleft",legend="* = true difference",cex=1.5)
```
...
pheatmap(sig.disc[o,4:9], scale="none", cluster_rows = FALSE, cluster_cols = FALSE, main = "Proportion of significant tests, ordered by fold-change")
```
